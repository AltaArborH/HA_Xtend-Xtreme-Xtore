...
Dependencies
    ...
    HA_connection_Xtend for the connection to and sensors from Xtend and Xtreme
    Card Mod (HACS) for animation and styling
    Mushroom Title Card (HACS) for some headers
